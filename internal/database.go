...
func autoMigrate() error {
	...
	ensureDocumentTemplateColumns := map[string]string{
		...
		"gcs_path_pdf":       "ALTER TABLE document_templates ADD COLUMN gcs_path_pdf text",
		"gcs_path_thumbnail": "ALTER TABLE document_templates ADD COLUMN gcs_path_thumbnail text",
